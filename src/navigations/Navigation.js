    ...
    return (
        <Tab.Navigator
            screenOptions={{
                ...
                headerStyle: { backgroundColor: '#FFFFFF', borderBottomWidth: 1, borderBottomColor: '#ACA9A9' },
                headerTitleStyle: { color: "#00A9FF", fontSize: 23 }
            }}>
            <Tab.Screen
                name="HomeScreen"
            ...
            {role === 'admin' && (
                <Tab.Screen
                    ...
                    options={{
                        ...
                        headerTitleStyle: { color: "#00A9FF", fontSize: 23 },
                        tabBarIcon: ({ color }) => (
                            <MaterialCommunityIcons name="wrench" color={color} size={28} />
                        )
                    }}
                />
            )}
