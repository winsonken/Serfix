            ...
            <View className="flex w-full h-full">
                <View className="flex justify-center items-center gap-y-5 flex-1">
                    ...
                    <View className="flex flex-row items-center flex-wrap justify-center gap-2 w-full">
                        <TouchableOpacity className="bg-[#89CFF3] flex items-center px-2 py-1 rounded-xl shadow-sm shadow-[#ACA9A9]" onPress={() => { navigation.navigate('FeedbackScreen')}}>
                        ...
                        <TouchableOpacity className="bg-[#89CFF3] flex items-center px-2 py-1 rounded-xl shadow-sm shadow-[#ACA9A9]" onPress={() => { navigation.navigate('FeedbackScreen')}}>
                            <Image source={require('../../../assets/helpcenter/partner.png')} className="w-[70px] h-[70px]" />
                            <Text className="text-xs font-bold  mt-1">Partner</Text>
                        </TouchableOpacity>
